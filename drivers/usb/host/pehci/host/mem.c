...
phci_hcd_mem_init(void)
{
	...
	for (i = BLK_128_; i < (BLK_128_ + BLK_256_); i++) {
		memaddr = &memalloc[i];
		memaddr->blk_num = i;
		memaddr->used = 0;
	...
	for (i = (BLK_128_ + BLK_256_ + BLK_1024_ + BLK_2048_);
		BLK_4096_ != 0 && i < (BLK_128_ + BLK_256_ + BLK_1024_ + BLK_2048_ + BLK_4096_);
		i++){
		memaddr = &memalloc[i];
		memaddr->blk_num = i;
		memaddr->used = 0;
	...
	for (i = (BLK_128_ + BLK_256_ + BLK_1024_ + BLK_2048_ + BLK_4096_); BLK_8196_ != 0 && i <
